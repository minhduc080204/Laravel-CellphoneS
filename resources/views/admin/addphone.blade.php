...
@section('title', 'Thêm Điện thoại')
@section('main')
    <form action="{{ route("addphone") }}" method="post" enctype="multipart/form-data">
        @csrf
        <h2 class="mb-4 border-bottom border-3 border-danger">Thêm sản phẩm (Phone)</h2>
        <div class="row">
        ...
        <div class="row m-1">
            ...
            <div class="input-group mb-3">
                <input required name="screen" type="text" class="form-control" placeholder="Nhập màn hình" aria-label="Nhập màn hình" aria-describedby="basic-addon2">
            </div>
            </div>
            <div class="col-4 p-1">
            <div><strong>Camera sau</strong></div>
            <div class="input-group mb-3">
                <input required name="cameraaf" type="text" class="form-control" placeholder="Nhập Camera sau" aria-label="Nhập Camera sau" aria-describedby="basic-addon2">
            </div>
            </div>
            <div class="col-4 p-1">
            <div><strong>Camera trước</strong></div>
            <div class="input-group mb-3">
                <input required name="camerabf" type="text" class="form-control" placeholder="Nhập Camera trước" aria-label="Nhập Camera trước" aria-describedby="basic-addon2">
            </div>
            </div>
            <div class="col-4 p-1">
            <div><strong>Chip CPU</strong></div>
            <div class="input-group mb-3">
                <input required name="cpu" type="text" class="form-control" placeholder="Nhập chip CPU" aria-label="Nhập chip CPU" aria-describedby="basic-addon2">
            </div>
            </div>
            <div class="col-4 p-1">
            <div><strong>Dung lượng RAM</strong></div>
            <div class="input-group mb-3">
                <input required name="ram" type="text" class="form-control" placeholder="Nhập thông tin về RAM" aria-label="Nhập thông tin về RAM" aria-describedby="basic-addon2">
            </div>
            </div>
            <div class="col-4 p-1">
